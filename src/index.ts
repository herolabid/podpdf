...
export interface TextOpts { size?: number; color?: Color; align?: Align; weight?: Weight; maxWidth?: number }
...
export class PDF {
  private pages: Page[] = []; private cur: Page | null = null; private sz: Size
  ...
  build(): Uint8Array {
    ...
    s.l('trailer').l(`<</Size ${oid + 1}/Root ${catId} 0 R>>`).l('startxref').l(xref.toString()).l('%%EOF')
    return s.out()
  }
